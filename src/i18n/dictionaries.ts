...
export const dictionaries = {
  pt: {
    ...
    ai: {
      ...
      concurrencyError: "Outra chamada de IA já está em andamento. Aguarde a anterior terminar.",
    ...
    form: {
      ...
      importUrl: "Importar de URL (GitHub / Gist)",
      importUrlPlaceholder: "Cole o link do arquivo no GitHub ou Gist...",
      importButton: "Importar",
      importing: "Importando...",
      importSuccess: "Snippet importado com sucesso!",
      importError: "Erro ao importar snippet. Verifique a URL.",
  ...
  en: {
    ...
    ai: {
      ...
      concurrencyError: "Another AI request is already in progress. Please wait for it to finish.",
    ...
    form: {
      ...
      importUrl: "Import from URL (GitHub / Gist)",
      importUrlPlaceholder: "Paste the link to the GitHub or Gist file...",
      importButton: "Import",
      importing: "Importing...",
      importSuccess: "Snippet imported successfully!",
      importError: "Failed to import snippet. Verify the URL.",
