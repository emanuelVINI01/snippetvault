...
export default function SnippetCardFooter({ onDelete, onEdit, snippet }: SnippetCardFooterProps) {
  return (
    <div className="flex min-w-0 items-center justify-between gap-3 px-4 pb-4 pt-1">
      <SnippetTags tags={snippet.tags} />
      <SnippetActions snippet={snippet} onDelete={onDelete} onEdit={onEdit} />
    </div>
  );
}
